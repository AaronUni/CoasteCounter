...
public class AchterbahnDB {
    ...
    public static Achterbahn colossos_HeidePark = new Achterbahn(0, "Colossos - Kampf der Giganten", 1344,
    ...
    public static Achterbahn kaernan_HansaPark = new Achterbahn(1, "Schwur des Kärnan", 1235, 73, 67.0,
    ...
    public static Achterbahn blueFire_Europapark = new Achterbahn(2, "Blue Fire Megacoaster", 1056, 38, 32, 4,
    ...
    Achterbahn nessi_HansaPark = new Achterbahn(3, "Nessi", 741, 26, 24, 1, "Looping, Helix", 1700, 7, 2, "Schwarzkopf",
