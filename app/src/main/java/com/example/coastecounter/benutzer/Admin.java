...
public class Admin extends Benutzer {
    ...
    public boolean editPark(Park park, String name, String email, String adress,
                            String telephone, String image, Parkbetreiber owner, Theme theme,
                            String website, Date openingHours, Date closingHours, String description) {
        return false;
    }
    ...
    public boolean createBadge(String title, String description, String condition,
                               List<Badgekategorie> categories, String image) {
        return false;
    }
