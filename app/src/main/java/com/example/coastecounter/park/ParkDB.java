...
public class ParkDB {
    ...
    public ParkDB() {
        ...
        heidePark.addAchterbahn(achterbahnDB.getList().get(1));
        parkList.add(heidePark);
        hansaPark.addAchterbahn(achterbahnDB.getList().get(1));
        parkList.add(hansaPark);
        europaPark.addAchterbahn(achterbahnDB.getList().get(2));
        parkList.add(europaPark);
        hansaPark.addAchterbahn(achterbahnDB.getList().get(3));
    }
